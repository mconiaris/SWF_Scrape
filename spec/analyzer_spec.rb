...
RSpec.describe Analyzer do
	...
	describe '#calculate_dc_points' do
		...
		xcontext 'when a hash with a key of \':DC03\' and a value of \'A\' is passed' do
			dc_key = :DC03
			dc_value = 'A'
			it 'returns 0' do
		...
		xcontext 'when a hash with a key of \':DC04\' and a value of \'A\' is passed' do
			dc_key = :DC04
			dc_value = 'A'
			it 'returns 0' do
				expect(analyze.calculate_dc_points(dc_key, dc_value)).to eq(0)
		...
		xcontext 'when a hash with a key of \':DC07\' and a value of \'A\' is passed' do
			dc_key = :DC07
			dc_value = 'A'
			it 'returns 0' do
				expect(analyze.calculate_dc_points(dc_key, dc_value)).to eq(0)
		...
		xcontext 'when a hash with a key of \':DC08\' and a value of \'A\' is passed' do
			dc_key = :DC08
			dc_value = 'A'
			it 'returns 0' do
				expect(analyze.calculate_dc_points(dc_key, dc_value)).to eq(0)
		...
		xcontext 'when a hash with a key of \':DC09\' and a value of \'A\' is passed' do
			dc_key = :DC09
			dc_value = 'A'
			it 'returns 0' do
				expect(analyze.calculate_dc_points(dc_key, dc_value)).to eq(0)
		...
		xcontext 'when a hash with a key of \':DC10\' and a value of \'A\' is passed' do
			dc_key = :DC10
			dc_value = 'A'
			it 'returns 0' do
				expect(analyze.calculate_dc_points(dc_key, dc_value)).to eq(0)
		...
		xcontext 'when a hash with a key of \':DC11\' and a value of \'A\' is passed' do
			dc_key = :DC11
			dc_value = 'A'
			it 'returns 0' do
				expect(analyze.calculate_dc_points(dc_key, dc_value)).to eq(0)
		...
		xcontext 'when a hash with a key of \':DC12\' and a value of \'A\' is passed' do
			dc_key = :DC12
			dc_value = 'A'
			it 'returns 0' do
				expect(analyze.calculate_dc_points(dc_key, dc_value)).to eq(0)
