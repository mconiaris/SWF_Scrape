...
RSpec.describe Analyzer do
	...
	describe '#calculate_probability' do
		...
		context 'when an Integer of 9 is passed' do
			it 'should return 4/36.to_r' do
				expect(analyze.calculate_probability(9)).to eq(4/36.to_r)
			end
		end
		context 'when an Integer of 10 is passed' do
			it 'should return 3/36.to_r' do
				expect(analyze.calculate_probability(10)).to eq(3/36.to_r)
			end
		end
		context 'when an Integer of 11 is passed' do
			it 'should return 2/36.to_r' do
				expect(analyze.calculate_probability(11)).to eq(2/36.to_r)
			end
		end
		context 'when an Integer of 12 is passed' do
			it 'should return 1/36.to_r' do
				expect(analyze.calculate_probability(12)).to eq(1/36.to_r)
			end
		end
	end
