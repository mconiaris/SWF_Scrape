class Wrestler
	...
	def wrestler_points_output(wrestler)
		...
		f.write("R-2-(XX) (0 or 1), #{wrestler.points[:RO02_xx]}0\n")
		f.write("R-3-(XX) (0 or 1), #{wrestler.points[:RO03_xx]}0\n")
		f.write("R-4-(XX) (0 or 1), #{wrestler.points[:RO04_xx]}0\n")
		f.write("R-5-(XX) (0 or 1), #{wrestler.points[:RO05_xx]}0\n")
		f.write("R-6-(XX) (0 or 1), #{wrestler.points[:RO06_xx]}0\n")
		f.write("R-7-(XX) (0 or 1), #{wrestler.points[:RO07_xx]}0\n")
		f.write("R-8-(XX) (0 or 1), #{wrestler.points[:RO08_xx]}0\n")
		f.write("R-9-(XX) (0 or 1), #{wrestler.points[:RO09_xx]}0\n")
		f.write("R-10-(XX) (0 or 1), #{wrestler.points[:RO10_xx]}0\n")
		f.write("R-11-(XX) (0 or 1), #{wrestler.points[:RO11_xx]}0\n")
		f.write("R-12-(XX) (0 or 1), #{wrestler.points[:RO12_xx]}0\n")
