class Wrestler
	...
	def wrestler_points_output(wrestler)
		...
		f.write("Specialty Roll Probability in OC (x/36), 0\n")
		...
		f.write("Specialty Roll Probability-DQ (x/6), 0\n")
		f.write("Specialty Roll Probability-P/A (x/6), 0\n")
		f.write("Specialty Roll Probability-* (x/6), 0\n")
		f.write("Specialty Roll Probability-XX (x/6), 0\n")
		...
		f.write("OC Ropes Roll Probability (x/3),0\n")
		f.write("Ropes (S) Roll Probability (x/36), 0\n")
